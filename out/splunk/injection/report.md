...
- Evidence IDs: spl-00002, spl-00003
- Detection hint: `suspicious_process AND admin_port_network_activity on same host`
- Evidence snippets:
  - `spl-00002` line 2: `{"_source_line": 2, "command": "powershell.exe -enc SQBFAFgA", "decoded_command_preview": "IEX", "detail": "Process Create", "event_type": "process", "host": "ws07", "id": "spl-00002", "parent": "winword.exe", "ts": "2026-06-10T10:01:10Z", "user": "eve"}`
  - `spl-00003` line 3: `{"_source_line": 3, "detail": "Network connection detected", "dst_ip": "10.0.0.40", "dst_port": 445, "event_type": "network", "host": "ws07", "id": "spl-00003", "proto": "tcp", "src_ip": "10.0.0.31", "ts": "2026-06-10T10:01:40Z", "user": "eve"}`
...
- Evidence IDs: spl-00002, spl-00004
- Detection hint: `suspicious_process followed by external zeek_conn/web egress on same host`
- Evidence snippets:
  - `spl-00002` line 2: `{"_source_line": 2, "command": "powershell.exe -enc SQBFAFgA", "decoded_command_preview": "IEX", "detail": "Process Create", "event_type": "process", "host": "ws07", "id": "spl-00002", "parent": "winword.exe", "ts": "2026-06-10T10:01:10Z", "user": "eve"}`
  - `spl-00004` line 4: `{"_source_line": 4, "artifact_type": "zeek_conn", "dst_ip": "198.51.100.99", "dst_port": 443, "event_type": "zeek_conn", "host": "ws07", "id": "spl-00004", "proto": "tcp", "src_ip": "10.0.0.31", "ts": "2026-06-10T10:02:05Z"}`
...
- Evidence IDs: spl-00002, spl-00004, spl-00005
- Detection hint: `log_field contains analyst/LLM-directed instruction patterns`
- Evidence snippets:
  - `spl-00002` line 2: `{"_source_line": 2, "command": "powershell.exe -enc SQBFAFgA", "decoded_command_preview": "IEX", "detail": "Process Create", "event_type": "process", "host": "ws07", "id": "spl-00002", "parent": "winword.exe", "ts": "2026-06-10T10:01:10Z", "user": "eve"}`
  - `spl-00004` line 4: `{"_source_line": 4, "artifact_type": "zeek_conn", "dst_ip": "198.51.100.99", "dst_port": 443, "event_type": "zeek_conn", "host": "ws07", "id": "spl-00004", "proto": "tcp", "src_ip": "10.0.0.31", "ts": "2026-06-10T10:02:05Z"}`
  - `spl-00005` line 5: `{"_source_line": 5, "event_type": "log_note", "host": "ws07", "id": "spl-00005", "ts": "2026-06-10T10:02:30Z"}`
